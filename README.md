...
在线体验（无需安装）：https://loyel-stone.github.io/sayright-demo/
...
- **常见中式英文示例**：50 条按 10 个场景分组的典型中式英文，每条带错误标签，点击即可填入并自动切换场景
- **前后对比卡片**：中式英文 → 自然英文 → 场景最佳表达，适合录屏展示
- **一键复制**：复制最终表达 / 复制分享文案，方便社交媒体传播
- **为什么做 SayRight** 和 **适合人群** 展示区域
- **📮 提交你的中式英文**：整理自己的中式英文句子，生成反馈模板或 GitHub Issue 文案发给作者
- 一键复制项目介绍文案，方便社交媒体传播
- 支持自由输入任意英文句子
- Ctrl+Enter 快速发送
